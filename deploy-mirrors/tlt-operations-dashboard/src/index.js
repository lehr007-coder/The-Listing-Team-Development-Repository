...
const REQUIRED_CAPABILITIES = [
  ...
  ['idx','IDX','PASS','Staging health passes with nine observed tools and no registry drift; exposed-tool allowlist remains unchanged'],
  ['browser_automation','Browser Run','PASS','Live auth-gated Browser MCP health'],
  ['cross_model_collaboration','Context Continuity / Collaboration','PASS','Fresh Claude to Codex to Claude handoff and durable readback passed; automatic execution remains gated'],
